...
/*
 * Market place to trade Dogos (should **in theory** be used for any ERC721 token)
 * It needs an existing Dogo contract to interact with
 * Note: it does not inherit from the Dogo contracts
